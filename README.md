...
[![Machine Learning](https://img.shields.io/badge/Machine%20Learning-424242?style=for-the-badge)]()
...
**Security Tools**  
`Metasploit` `Hydra` `Wireshark` `MySQL` `Nmap` `Burp Suite` `SQLMap` `Nessus` `Mininet`
